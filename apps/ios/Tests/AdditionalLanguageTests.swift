...
final class AdditionalLanguageTests: XCTestCase {
    private let ids = ["de", "it", "pt", "zh", "ko"]
    private let samples = [
    ...
    func testRegistrationPreservesOldIDsAndSetsRequestedVarieties() {
        XCTAssertEqual(LanguageRegistry.all.map(\.id), ["nb", "es", "en", "fr", "de", "it", "pt", "zh", "ko"])
        for (id, locale, greeting) in [("de", "de-DE", "Hallo!"), ("it", "it-IT", "Ciao!"), ("pt", "pt-BR", "Olá!"), ("zh", "zh-CN", "你好！"), ("ko", "ko-KR", "안녕하세요!")] {
