...
const korean: LanguageModule = {
  ...
  themeOverrides: {
    coffee: theme("coffee", "커피 한 잔?", "Something warm, please", "cup.and.saucer", "Everyday", "Meet in a neighbourhood café in Korea. Order a drink and chat in Korean, following the learner's interests.", 0),
    groceries: theme("groceries", "시장에서", "Find something good", "basket", "Everyday", "Shop at a Korean market or supermarket. Practise quantities, native and Sino-Korean numbers, prices and polite requests.", 2),
    travel: theme("travel", "다음 정거장", "A ticket to somewhere", "tram", "Everyday", "Plan a trip in Korea by subway, KTX or bus. Discuss routes and tickets without inventing current schedules.", 1),
    cabin: theme("cabin", "주말 나들이", "A change of scene", "mountain.2", "Local life", "Imagine a weekend trip together: a mountain hike, the coast or a small town. Discuss practical plans and what you enjoy doing.", 2),
    traditions: theme("traditions", "일상의 예절", "Small customs, big stories", "flag", "Local life", "Talk about everyday customs and holidays such as 설날 and 추석. Compare them with places the learner knows and avoid presenting any habit as universal.", 2),
  },
};

export const LanguageRegistry = {
  defaultID: "nb",
  all: [norwegian, spanish, english, french, german, italian, portuguese, mandarin, korean] as readonly LanguageModule[],
